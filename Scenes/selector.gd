...
func set_selector_position(pos:Vector2i, size:Vector2i):
	var pixelPos = map.translate_coord_to_px(pos) + Vector2i(5, 2);
	var pixelSize:Vector2i = map.translate_coord_to_px(size) + Vector2i(6, 8);
	top.size = pixelSize
